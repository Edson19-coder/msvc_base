CREATE OR REPLACE PACKAGE BODY MSVC_BASE.PKG_USER AS
    ...
    PROCEDURE CREATE_USER(vUserName IN VARCHAR2, vEmail IN VARCHAR2, vPassword IN VARCHAR, vResponse OUT VARCHAR2) IS
    BEGIN
    ...
    PROCEDURE UPDATE_USER(vUserId IN NUMBER, vUserName IN VARCHAR2, vEmail IN VARCHAR2, vPassword IN VARCHAR, vActive IN NUMBER, vResponse OUT VARCHAR2) IS
    BEGIN
        UPDATE MSVC_BASE.MB_USERS SET USER_NAME = vUserName, USER_EMAIL = vEmail, PASSWORD = vPassword, ACTIVE = vActive 
